        ...
        <section className={styles["help-portal__guidebook"]}>
          <div className={styles["guidebook-wrapper"] + " container"}>
            <div className={styles["guidebook"]}>
              <img loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/samahan-website.appspot.com/o/Images%2Fguidebook.png?alt=media&token=5a320c7d-d038-47eb-b1db-bd3bf5d2e271" alt="SAMAHAN Guidebook" draggable={false}/>
            </div>
