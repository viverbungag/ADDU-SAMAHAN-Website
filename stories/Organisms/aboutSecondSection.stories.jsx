...
export default {
  ...
  export const Main ={
    args:{
        ...
        secondParagraph:
        "In heeding the call of today, we welcome a new wave of stories, both of struggles and success, as we work for a SAMAHAN that is now student-centric in providing spaces for every individual to grow in one’s own craft, a SAMAHAN that is now agenda-driven in pursuing causes that provide meaning and impact within our respective communities, and a SAMAHAN that is now present-minded in the execution of its plans while remaining grounded by the limits of reality. Through this, we highlight the need to couple responsiveness with novelty that is innovative in shaping the visions of every Atenean.",
        thirdParagraph:
